...
// Derive level from tier (T1→1, T2→2, T3→3, T4→4, progress=100→5)
...
// Seeded pseudo-random so elo stays the same per skill across renders
...
export function getSkillElo(skill) {
  ...
  // Use numeric part of skillId as seed (e.g. SK-003 → 3)
